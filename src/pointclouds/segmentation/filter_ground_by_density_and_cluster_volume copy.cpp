 ...
 */
PointCloud::Ptr
extractIndices (PointCloud::Ptr &cloud_in, std::vector<pcl::PointIndices> indx_vec)
{
  pcl::PointIndices::Ptr indices (new pcl::PointIndices);
  indices->indices.insert(indices->indices.end(), indx_vec.begin(), indx_vec.end());

  cout << "Tamaño del vector con insert: " << indices->indices.size() << endl;
 ...
 */
PointCloud::Ptr 
extractIndices (PointCloud::Ptr &cloud_in, pcl::PointIndices::Ptr &indices)
{
  PointCloud::Ptr cloud_out (new PointCloud);
  pcl::ExtractIndices<PointT> extract;
  extract.setInputCloud(cloud_in);

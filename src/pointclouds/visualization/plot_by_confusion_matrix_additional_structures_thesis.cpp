...
void plot_by_confusion_matrix(const fs::path GT_PATH, const fs::path PRED_PATH, const string CLOUD_NAME)
{
	...
	std::cout << "GT Path: " << gt_cloud_path.string() << std::endl;
	std::cout << "Pred Path: " << pred_cloud_path.string() << std::endl;
	...
	pcl::visualization::PointCloudColorHandlerCustom<PointT> tp_color(tp_cloud, 50, 190, 50);	// thesis_color_palette
	pcl::visualization::PointCloudColorHandlerCustom<PointT> tn_color(tn_cloud, 100, 100, 100); // thesis_color_palette
	pcl::visualization::PointCloudColorHandlerCustom<PointT> fp_color(fp_cloud, 200, 10, 10);	// thesis_color_palette
	pcl::visualization::PointCloudColorHandlerCustom<PointT> fn_color(fn_cloud, 255, 152, 0);	// thesis_color_palette
	...
	my_vis->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 8, "tp_cloud");
	my_vis->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 8, "tn_cloud");
	my_vis->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 8, "fp_cloud");
	my_vis->setPointCloudRenderingProperties(pcl::visualization::PCL_VISUALIZER_POINT_SIZE, 8, "fn_cloud");
...
int main()
{
	...
	assert(fs::exists(GT_PATH) && "GT PATH does not exist");
	assert(fs::exists(PRED_PATH) && "PRED PATH does not exist");
	...
	for (const auto &entry : pred_files)
	{
		...
		std::cout << "Processing Cloud: " << CLOUD_NAME << std::endl;
		plot_by_confusion_matrix(GT_PATH, PRED_PATH, CLOUD_NAME);
	}
	return 0;
}
